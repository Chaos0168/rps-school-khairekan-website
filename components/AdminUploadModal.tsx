...
export default function AdminUploadModal({
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      uploadFormData.append('type', formData.type.toUpperCase())
      uploadFormData.append('subjectId', subjectId.toString())
      uploadFormData.append('uploadedById', user.id)
      
      // Add file for non-quiz resources
      if (formData.type !== 'quiz' && formData.file) {
        uploadFormData.append('file', formData.file)
      }
      
      // Add quiz data for quiz resources
      if (formData.type === 'quiz') {
        uploadFormData.append('duration', quizData.duration.toString())
        uploadFormData.append('difficulty', quizData.difficulty.toUpperCase())
        ...
        uploadFormData.append('questions', JSON.stringify(questions))
      }
